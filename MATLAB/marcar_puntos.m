fich1=uigetfile('willis2.jpg'); im1=imread(fich1);
fich2=uigetfile('ant2.jpg');    im2=imread(fich2);
...
while (but==1)             
  ...
  plot(px,py,[col 'o'],'MarkerSize',3,'MarkerFaceColor',col);         
  [px py but] = ginput(1);    
end    
